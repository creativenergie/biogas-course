...
<div style="border:2px solid #a5d6a7;border-radius:10px;padding:1rem 1.2rem;background:#f1f8e9;margin-top:1rem;">
  ...
  <table style="width:100%;border-collapse:collapse;font-size:0.84rem;">
    ...
    <tr><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Ask about cows → sizing formula</td><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Session 2 — Sizing (cows × 0.4 m³/day)</td></tr>
    <tr style="background:#fafafa;"><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Cash / Loan / PAYG payment negotiation</td><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Session 8 — Biogas as a business, financial models</td></tr>
    <tr><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">PAYG customers stop paying when unhappy</td><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Session 8 — Long-term customer relationship management</td></tr>
    <tr style="background:#fafafa;"><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Loan repayment tracked week by week</td><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Session 8 — Cash flow and recurring income</td></tr>
    <tr><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Training pitch: daily feeding, safety, checks</td><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Session 4 — Safety &amp; EAT protocol</td></tr>
    <tr style="background:#fafafa;"><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Smart meter: faster alerts, lower repair cost</td><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Session 8 — Business efficiency tools</td></tr>
    <tr><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Productive use: surplus gas → weekly income</td><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Session 6 — Productive Use</td></tr>
    <tr style="background:#fafafa;"><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Maintenance events: trained vs untrained outcomes</td><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Session 4 — Safety consequences</td></tr>
    <tr><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">90-second week timer — act or fall behind</td><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Session 8 — Running a business requires active management</td></tr>
    <tr style="background:#fafafa;"><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Village progression: reputation drives referrals</td><td style="padding:0.35rem 0.75rem;border:1px solid #dce775;">Session 8 — Business growth through reputation</td></tr>
  </table>
</div>
```
